...
export default async function Registros(props: IPagePedidosProps) {
  ...
  const result = await HistoricoService.getAll(filter, undefined, undefined, sort);
  ...
  return (
    <main className="flex flex-col">
      <div className="flex gap-2 h-[calc(100vh-56px)] justify-center items-center overflow-hidden">
        ...
        <div className="w-[90%] max-h-[700px] flex flex-col gap-2 p-4 bg-paper border-primary border rounded-lg shadow-md overflow-y-auto">
